  ...
  return (
    ...
    <div className="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
        <div className="grid grid-cols-2 md:col-span-3 lg:grid-cols-6 gap-y-16 gap-x-12">
            ...
            <div>
                <p className="text-sm font-semibold tracking-widest text-white-400 uppercase">Company</p>

                <ul className="mt-6 space-y-4">
                    <li>
                        <a href="#" title="" className="flex text-base text-white transition-all duration-200 hover:text-gray-600 focus:text-blue-600"> About </a>
                    </li>
        ...
        <p className="text-sm text-center text-white-600">© Copyright 2025, All Rights Reserved by Avinx_Health</p>
    </div>
</section>
    </div>
  );
